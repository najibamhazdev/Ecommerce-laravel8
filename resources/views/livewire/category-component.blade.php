								...
								<div class="product col-md-4 col-sm-6 col-12">
									<div class="grid-inner">
										<div class="product-image">
                                            ...
                                            <div class="sale-flash badge bg-primary p-2">In Stock</div>
                                            @else
								...
								<div class="widget widget_links clearfix">
									...
									<ul class="categories">
                                            @foreach($categories as $category)
                                                <li @if($selected_category->id === $category->id ) class="active"  @endif><a href="{{ route('product.category',['slug'=>$category->slug]) }}">{{$category->name}}</a></li>
                                            @endforeach
									</ul>
