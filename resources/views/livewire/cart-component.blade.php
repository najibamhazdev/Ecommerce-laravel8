                            ...
                            @foreach(Cart::content() as $item)
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="cart-product-thumbnail">
                                            <a href="{{route('product.details',['slug'=>$item->model->slug])}}"><img width="64" height="64" src="{{ asset('images/shop/dress') }}/{{$item->model->image}}" alt="{{$item->model->name}}"></a>
                                        </td>
                                        <td class="cart-product-thumbnail">
                                        ...
                                        <td class="cart-product-price">
                                            <span class="amount">${{$item->model->sale_price}}</span>
                                        </td>

                                        <td class="cart-product-quantity">
                                            <div class="quantity">
                                                <input type="button" value="-" class="minus" wire:click.prevent="decreaseQty('{{$item->rowId}}');">
                                                <input type="text" name="quantity" value="{{$item->qty}}" class="qty"  />
                                                <input type="button" value="+" class="plus" wire:click.prevent="increaseQty('{{$item->rowId}}');">
                                            </div>
                                        </td>
                                        ...
                                        <td class="cart-product-remove">
                                            <a href="#" class="remove" title="Remove this item" wire:click.prevent="destroyRow('{{$item->rowId}}');"><i class="icon-trash2"></i></a>
                                        </td>
							...
							<tr class="cart_item">
								<td colspan="6">
									<div class="row justify-content-between py-2 col-mb-30">
                                        ...
                                        <a href="#" class="btn btn-danger" wire:click.prevent="destroyAll();">CLEAR CART</a>
