						...
						<div class="container py-5">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px;">
                                ...
                                @endif
									...
									<form id="login-form" name="login-form" class="mb-0" wire:submit.prevent="updateproduct" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-10"><h3>Edit Product</h3></div>
										...
										<div class="row">
                                            ...
                                            <div class="col-12 form-group">
                                                ...
                                                @if($newimage)
                                                    <img src="{{$newimage->temporaryUrl()}}" width="120" alt="" wire:model="newimage">
                                                @else
                                            ...
                                            <div class="col-12 form-group">
                                                ...
                                                @if($newimage2)
                                                    <img src="{{$newimage2->temporaryUrl()}}" width="120" alt="" wire:model="newimage2">
                                                @else
                                                    <img src="{{asset('assets/images/products')}}/{{$image2}}" width="120" alt="">
                                                @endif
											</div>
