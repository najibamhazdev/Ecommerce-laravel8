									...
									<tbody>
										<tr class="cart_item">
											<td class="cart-product-thumbnail">
												<a href="#"><img width="64" height="64" src="{{ asset('images/shop/thumbs/small/dress-3.jpg') }}" alt="Pink Printed Dress"></a>
											</td>
										...
										<tr class="cart_item">
											<td class="cart-product-thumbnail">
												<a href="#"><img width="64" height="64" src="{{ asset('images/shop/thumbs/small/shoes-2.jpg') }}" alt="Checked Canvas Shoes"></a>
											</td>
										...
										<tr class="cart_item">
											<td class="cart-product-thumbnail">
												<a href="#"><img width="64" height="64" src="{{ asset('images/shop/thumbs/small/tshirt-2.jpg') }}" alt="Pink Printed Dress"></a>
											</td>
